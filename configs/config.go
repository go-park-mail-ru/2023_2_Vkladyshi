...
type DbDsnCfg struct {
	...
	Films_db      string `yaml:"postgres_films"`
	Genres_db     string `yaml:"postgres_genres"`
	Crew_db       string `yaml:"postgres_crew"`
	Profession_db string `yaml:"postgres_profession"`
}
